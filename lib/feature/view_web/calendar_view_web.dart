...
class CalendarPageViewWeb extends StatefulWidget {
  const CalendarPageViewWeb({Key? key}) : super(key: key);

  @override
  State<CalendarPageViewWeb> createState() => _CalendarPageViewWebState();
}

class _CalendarPageViewWebState extends State<CalendarPageViewWeb> {
  ...
  void viewChanged(ViewChangedDetails viewChangedDetails) {
    if (_controller.view == CalendarView.week) {
      ...
      SchedulerBinding.instance.addPostFrameCallback((Duration duration) {
        if (_dayFormat != 'EEEE' || _dateFormat != 'dd') {
          setState(() {
            _dayFormat = 'EEEE';
            _dateFormat = 'dd';
          });
